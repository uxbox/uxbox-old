(ns uxbox.icons-sets.material-design-notification
  (:require [uxbox.icons-sets.register]
            [uxbox.pubsub :as pubsub]))

(def material-design-notification (sorted-map
   :adb {
    :name "ADB"
    :svg [:path
     {:style {:stroke nil},
...
(pubsub/publish! [:register-icons-set {:key :material-design-notification :name "Material Design (Notification)" :icons material-design-notification}])
