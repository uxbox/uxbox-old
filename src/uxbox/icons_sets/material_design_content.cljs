...
(def material-design-content (sorted-map
   ...
   :forward {
    :name "Forward"
    :svg [:path
     {:style {:stroke nil}, :d "M24 16v-8l16 16-16 16v-8h-16v-16z"}]}
   :gesture {
    :name "Gesture"
    :svg [:path
     {:style {:stroke nil},
   ...
   :remove {
    :name "Remove"
    :svg [:path {:style {:stroke nil}, :d "M38 26h-28v-4h28v4z"}]}
   :remove-outline {
    :name "Remove Outline"
    :svg [:path
     {:style {:stroke nil},
...
(pubsub/publish! [:register-icons-set {:key :material-design-content :name "Material Design (Content)" :icons material-design-content}])
