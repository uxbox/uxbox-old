(ns uxbox.icons-sets.material-design-navigation
...
(def material-design-navigation (sorted-map
   ...
   :arrow-drop-down {
    ...
    :svg [:path {:style {:stroke nil}, :d "M14 20l10 10 10-10z"}]}
   ...
   :arrow-drop-up {
    :name "Arrow Drop Up"
    :svg [:path {:style {:stroke nil}, :d "M14 28l10-10 10 10z"}]}
   :arrow-forward {
    :name "Arrow Forward"
    :svg [:path
     {:style {:stroke nil},
...
(pubsub/publish! [:register-icons-set {:key :material-design-navigation :name "Material Design (Navigation)" :icons material-design-navigation}])
