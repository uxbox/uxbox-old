(ns uxbox.icons-sets.material-design-device
  (:require [uxbox.icons-sets.register]
            [uxbox.pubsub :as pubsub]))

(def material-design-device (sorted-map
   :access-alarm {
    :name "Access Alarm"
    :svg [:path
     {:style {:stroke nil},
   ...
   :network-cell {
    :name "Network Cell"
    :svg [:g
     [:path {:style {:stroke nil}, :d "M34 14l-30 30h30z"}]
     [:path {:style {:stroke nil}, :d "M4 44h40v-40z", :fill-opacity ".3"}]]}
   :network-wifi {
    :name "Network Wifi"
    :svg [:g
     [:path
   ...
   :signal-cellular-0-bar {
    ...
    :svg [:path
     {:style {:stroke nil}, :d "M4 44h40v-40z", :fill-opacity ".3"}]}
   :signal-cellular-1-bar {
    :name "Signal Cellular 1 Bar"
    :svg [:g
     [:path {:style {:stroke nil}, :d "M24 24l-20 20h20z"}]
     [:path {:style {:stroke nil}, :d "M4 44h40v-40z", :fill-opacity ".3"}]]}
   :signal-cellular-2-bar {
    :name "Signal Cellular 2 Bar"
    :svg [:g
     [:path {:style {:stroke nil}, :d "M28 20l-24 24h24z"}]
     [:path {:style {:stroke nil}, :d "M4 44h40v-40z", :fill-opacity ".3"}]]}
   ...
   :signal-cellular-4-bar {
    ...
    :svg [:path {:style {:stroke nil}, :d "M4 44h40v-40z"}]}
   :signal-cellular-connected-no-internet-0-bar {
    :name "Signal Cellular Connected No Internet 0 Bar"
    :svg [:g
     [:path {:style {:stroke nil}, :d "M40 44h4v-4h-4v4zm0-24v16h4v-16h-4z"}]
     [:path
      {:style {:stroke nil},
...
(pubsub/publish! [:register-icons-set {:key :material-design-device :name "Material Design (Device)" :icons material-design-device}])
