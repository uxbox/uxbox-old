(ns uxbox.icons-sets.material-design-maps
  (:require [uxbox.icons-sets.register]
            [uxbox.pubsub :as pubsub]))

(def material-design-maps (sorted-map
   :been-here {
    :name "Been Here"
    :svg [:path
     {:style {:stroke nil},
...
(pubsub/publish! [:register-icons-set {:key :material-design-maps :name "Material Design (Maps)" :icons material-design-maps}])
